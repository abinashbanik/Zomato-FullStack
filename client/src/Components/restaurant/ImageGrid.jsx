            ...
            <div className="hidden w-full h-96 md:flex gap-1">
                <div className="w-full h-full overflow-hidden">
                    <img 
                        src={props.images[0]}
                        alt="restaurant image"
                        className="w-full h-full rounded-lg object-cover transition duration-500 transform hover:scale-110"
                    />
                </div>
                ...
                <div  className="w-1/4 h-full flex flex-col gap-1 overflow-hidden">
                    <div className="w-full h-full relative">
                        ...
                        <h4 className="absolute inset-y-2/4 z-20 w-full h-full text-center text-white font-semibold">View Gallary</h4>
                    </div>
                    <div className="w-full h-full relative">
                        <img 
                            src={props.images[4]}
